...
<head>
	...
	<meta name="description" content="L2 Wolf Painel Administrativo"/>
	<meta http-equiv="content-language" content="pt-br" />
	<title>Lineage 2 Wolf Web Admin 3.1</title>
	<meta name="author" content="Lineage 2 Wolf" />
	<meta name="reply-to" content="lineagewolf20@gmail.com" />
	<meta name="language" content="Portuguese" />
	<meta name="copyright" content="Lineage 2 Wolf" />
	<meta name="distribution" content="Global" />
	<meta name="google" content="notranslate" />
	<meta property="og:title" content="L2 Wolf Web Admin 3.1" />
	<meta property="og:site_name" content="l2 Wolf Web Admin 3.1" />
	<meta property="og:description" content="L2 Wolf Painel Administrativo" />
...
<body class='login'>
	...
	<div class='copyright'>
		&copy; <?php echo date('Y'); ?> <a href='http://www.l2wolf.net' target='_blank'>Lineage 2 Wolf</a> - All rights reserved 
	</div>
...
<body class="hold-transition skin-blue sidebar-mini<?php echo (!empty($_COOKIE['sidebarCollapse']) ? (intval($_COOKIE['sidebarCollapse']) == 1 ? ' sidebar-collapse' : '') : '') . (!empty($_COOKIE['layoutBoxed']) ? (intval($_COOKIE['layoutBoxed']) == 1 ? ' layout-boxed' : '') : ''); ?>">
	...
	<div class="wrapper">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header">
									...
									<p>
										...
										<small>Desenvolvido por <a style='color: #fff;' href='http://www.l2wolf.net' target='_blank'>Lineage 2 Wolf</a></small>
									</p>
								</li>
							</ul>
						</li>
		...
		<footer class="main-footer">
			...
			<center>Lineage 2 Wolf Interlude Private Server - Painel Administrativo 3.1 </strong></center>
		</footer>
