				...
				*/ ?>
				<td>
					<select style='min-width: 160px;' name='metodo_pgto' id='metodo_pgto'>
						...
						if(!empty($PayPal['actived'])) { echo "<option data-symbol='R$' value='PayPal_BRL'>PayPal (BRL)</option>"; }
				...
				<td>
					<select style='min-width: 160px;' name='qtdCoins' id='qtdCoins'>
						...
						<?php
						for($i=1, $c=5; $i <= $c; $i++) { if($i%1==0) { echo "<option value='".$i."'>".$i." ".$coinName."'s</option>"; } }
