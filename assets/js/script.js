...
/* ===============================
   LOGIN PANEL - COMPATÍVEL COM SITE ANTIGO
=============================== */
        ...
        overlay.innerHTML = `
            <div class="login-captcha-box">
                ...
                <button class="captcha-close"
                        onclick="closeLoginCaptcha()">×</button>
                ...
                <div class="captcha-actions">
                    <button type="button"
                            onclick="reloadLoginCaptcha()">
                        Recarregar
                    </button>

                    <button type="button"
                            onclick="submitLoginWithCaptcha()">
                        Confirmar
                    </button>
                </div>
...
window.submitLoginWithCaptcha = function () {
    ...
    response.indexOf("'act':'OK'") !== -1 ||
    response.indexOf("document.location.replace") !== -1
) {
