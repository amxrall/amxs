...
$dbHost = "127.0.0.1";
$dbName = "stone";       // nome do seu banco
$dbUser = "root";     // usuário
$dbPass = "123456";   // senha
...
$sqlClan = $pdo->query("
    SELECT 
        ...
        COALESCE(cp.boss_points, 0) as boss_points, /* Puxa os pontos, se for nulo vira 0 */
        (
            SELECT COUNT(*)
            FROM characters ch
    ...
    LEFT JOIN clan_points cp ON c.clan_id = cp.clan_id /* JOIN COM A TABELA NOVA */
    ORDER BY boss_points DESC, c.reputation_score DESC /* ORDENA POR BOSS POINTS */
    LIMIT 5
");
...
<head>
    ...
    .floating-banner {
        ...
        /* RESPONSIVIDADE AQUI */
        width: 100%;           /* Tenta ocupar 100%... */
        max-width: 500px;      /* ...mas trava no limite de 500px */
    ...
    /* REGRA PARA CELULARES (Telas menores que 560px) */
    @media (max-width: 560px) {
        .floating-banner {
            left: 50%;              /* Move o ponto inicial para o meio */
            transform: translateX(-50%); /* Centraliza perfeitamente */
            bottom: 10px;           /* Fica um pouco mais baixo no celular */
...
<body>
<div class="floating-banner" id="banner"> <button class="close-btn"
      onclick="document.getElementById('banner').style.display='none'">×</button> <img src="/assets/img/ATENCAO.jpg"
      alt="Banner Promocional"> </div>
    <!-- PRELOADER -->
<div id="preloader">
    <div class="preloader-card">
        <div class="preloader-logo">

    <!-- OPÇÃO 1: LOGO EM TEXTO -->
    <!--<span class="logo-text">L2 STONE <span>PVP</span></span>-->

    <!-- OPÇÃO 2: LOGO EM IMAGEM -->
     <img src="assets/img/logo.png" alt="L2 Stone PVP" class="logo-img"> 
        ...
        <!-- ANTIGO -->
        <!-- <div class="preloader-text">LOADING SERVER...</div> -->
    ...
    <!-- OPÇÃO 1: LOGO EM TEXTO -->
    <!--<span class="logo-text">L2 <span>STONE</span> PVP</span>-->
    ...
    <nav class="nav">
		...
		<a href="https://www.l2stonepvp.com.br/donate/" target="_blank"><span style="color:#ffd46b;">DONATE</span></a>
    ...
    <nav class="mobile-nav">
        ...
        <a href="#ranking-section">Ranking</a>
        <a href="#news-section">Server Info</a>
		<a href="https://www.l2stonepvp.com.br/donate/"><span style="color:#ffd46b;">DONATE</span></a>
...
<center>
<center>
    <h2>X1000 <span style="color:green;">SERVER ONLINE</span></h2>

    <p>
        The server is officially online.  
        Create your character and start playing now!
    </p>
</center>
    <!-- BLOCO CENTRALIZADO -->
    <div class="hero-cta">
        ...
        <?php
        // ===== COUNTDOWN HERO DENTRO DA COLUNA =====
        if ($counterActived == 1) {
    ...
    <!-- LINHA DIVISÓRIA (ENTRE 1ª E 2ª SESSÃO) -->
...
Só um clã leva tudo. 🔥">
   Detail
            ...
            <article class="news-card">
                ...
                <div class="news-card__content">
                    <!--<div class="news-date"><span>20</span> 12.2025</div>-->
                    <h3 class="news-title">INFORMAÇOES GERAIS DO SERVIDOR</h3>
                    <p class="news-text">
                        📘 Informaçoes do servidor L2STONEPVP.
                    </p>
...
">Detail</a>
            ...
            <article class="news-card">
                ...
                <div class="news-card__content">
                    ...
                    <p class="news-text">
                        📈 Sistema de enchante do L2STONEPVP.
                    </p>
...
❌ Falha (Golden): Apenas o scroll é perdido">Detail</a>
            ...
            <article class="news-card">
                ...
                <div class="news-card__content">
                    <!--<div class="news-date"><span>11</span> 10.2025</div>-->
                    <h3 class="news-title">Regras da Olympiad</h3>
                    <p class="news-text">
                        Regras Olympiad L2STONEPVP.
                    </p>
...
📏 Enchant Máx. Olympiad: +30">Detail</a>
    ...
    <!-- LINHA DIVISÓRIA (ENTRE 2ª E 3ª SESSÃO) -->
    <div class="line d-flex">
        <div class="line__back"></div>
        <div class="line__def"></div>
        <div class="line__center"></div>
                ...
                <div class="ranking-box">
                    ...
                    <div class="ranking-table">
                        <div class="ranking-row ranking-row--head">
                            <span>#</span>
                            <span>Clan</span>
                            <span>Boss Pts</span> <span>Members</span>
                            <span>Leader</span>
                        </div>
    ...
    <!-- LINHA DIVISÓRIA (ENTRE 3ª E 4ª SESSÃO) -->
    <div class="line d-flex">
        <div class="line__back"></div>
        <div class="line__def"></div>
        <div class="line__center"></div>
            ...
            <div class="download-discord-layout">
                ...
                <div class="download-col">
                    ...
                    <div class="download-wrapper">
                        ...
                        <!-- MEDIAFIRE -->
                        <a href="https://www.mediafire.com/file/d4i2m8wotabwbgy/Patch-L2StonePVP.7z/file" target="_blank" class="download-card">
                            <div class="download-card-icon">
                                <img src="assets/img/icons/mediafire.png" alt="MediaFire">
                            </div>
                            <div class="download-card-title">Patch L2STONE</div>
						...
						<!-- MEDIAFIRE -->
                        <a href="https://www.l2stonepvp.com.br/file/system.rar" target="_blank" class="download-card">
                            <div class="download-card-icon">
                                <img src="assets/img/icons/mediafire.png" alt="MediaFire">
                            </div>
                            <div class="download-card-title">System (30/12/2025)</div>
                            <div class="download-card-sub">Jogue dentro da SYSTEM</div>
                        </a>

                        <!-- GOOGLE DRIVE
                        <a href="#google-drive-link" class="download-card">
                            <div class="download-card-icon">
                                <img src="assets/img/icons/drive.png" alt="Google Drive">
                            </div>
                            <div class="download-card-title">Google Drive</div>
                            <div class="download-card-sub">Fast &amp; Stable</div>
                        </a>-->

                        <!-- MEGA 
                        <a href="#mega-link" class="download-card">
                            <div class="download-card-icon">
                                <img src="assets/img/icons/mega.png" alt="Mega.nz">
                            </div>
                            <div class="download-card-title">Mega.nz</div>
                            <div class="download-card-sub">Mirror</div>
                        </a>-->
                ...
                <div class="discord-col">
                    ...
                    <div class="discord-widget-box">
                        <iframe
                            src="https://discord.com/widget?id=1447412671120150731&theme=dark"
    ...
    <footer class="footer">
        ...
        <div class="footer-content">
            ...
            <div class="footer-column">
                <h4>About</h4>
                <p>L2STONEPVP is a private Lineage II.gameserver bringing players the best PvP experience with stability and quality.</p>
            </div>
            ...
            <div class="footer-column">
                <h4>Contact</h4>
                <p>Email: l2stone.contato@gmail.com</p>
                <p><a href="https://discord.gg/aD3wgtc75M" target="_blank">Discord: L2STONE</a></p>
                <p>© 2026 L2 STONE PVP</p>
            </div>

        </div>

        <div class="footer-bottom">
            © 2026 L2 STONE PVP — All Rights Reserved. design by <a href="https://wa.me/5528999446993" target="_blank">AMX PROJECTS</a>
        </div>
...
<div id="discordPopup" class="discord-overlay">
  <div class="discord-box">
    ...
    <div class="discord-actions">
      <a href="https://discord.gg/RJXXA3xby8" target="_blank" class="discord-btn discord-join">
        Entrar no Discord
      </a>
...
<div id="registerModal" class="register-overlay">
    <div class="register-box">
        ...
        <p>Register now and start your journey on L2 STONE PVP.</p>
...
<a id="top-l2jbrasil-float"
   href="https://top.l2jbrasil.com/index.php?a=in&u=L2Stone"
   target="_blank"
   rel="noopener">
    <img src="https://top.l2jbrasil.com/button.php?u=L2Stone"
