...
<?php if($faceBoxOn == 1) { ?>
	<hr />
	<center><h1>Discord L2 BlackSoul</h1></center>
	<!--<div class='pddInner'>
		<?php echo $LANG[12998]; ?>
	</div>
	<style>
	...
	<iframe src="https://discord.com/widget?id=1413324512186994760&theme=dark" width="100%" height="287" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
<?php } ?>
