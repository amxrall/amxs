					...
					<div class="box-body">
						...
						<div class="box box-widget widget-user">
							<div class="widget-user-header bg-aqua-active">
								<center><h3 class="widget-user-username">Lineage 2 Greater</h3></center>
								<center><h5 class="widget-user-desc">Interlude Private Server - 2024</h5></center>
								<center><a href="http://www.l2wolf.net/" target="_blank" style="color: #fff;">www.greater.com</a></center>
							</div>
							<div class="box-footer">
								<div class="row">
									<div class="col-sm-3 border-right">
										<div class="description-block">
											<a href="#" class="btn btn-app" target="_blank"><i class="fa fa-comments"></i> Contato</a>
										</div>
									</div>
									<div class="col-sm-5 border-right">
										<div class="description-block">
											<h5 class="description-header">l2greater24@gmail.com</h5>
